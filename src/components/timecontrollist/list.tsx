...
import { getTimeControls, type TTask } from './timecontrol-data';
import { Task } from './timecontrol';
import { monitorForElements } from '@atlaskit/pragmatic-drag-and-drop/element/adapter';
import { isTaskData } from './timecontrol-data';
...
export function TimeControlList() {
    ...
    const handleCheckSorted = () => {
        setIsSorted(() => {
            return isTimeControlSorted(tasks)
        })
    }
